...
| shipping_update| Post-purchase shipping notification (extension)|

### Shipping Update Event (Extension)

The `shipping_update` event is an extension for delivering post-purchase messages generated by the Post-Purchase Agent:
...
| Field                    | Type   | Required | Description                    |
|:-------------------------|:-------|:---------|:-------------------------------|
| type                     | string | Yes      | `shipping_update`              |
| data.checkout_session_id | string | Yes      | Original checkout session ID   |
| data.order_id            | string | Yes      | Order identifier               |
| data.status              | enum   | Yes      | `order_confirmed`, `order_shipped`, `out_for_delivery`, `delivered` |
| data.language            | enum   | Yes      | `en`, `es`, `fr`               |
| data.subject             | string | Yes      | Message subject line           |
| data.message             | string | Yes      | Full message body              |
| data.tracking_url        | string | No       | Package tracking URL           |
